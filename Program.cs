...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharList = dogCharacteristic.Split(","); //new string array for multiple search terms
            for (int i = 0; i < dogCharList.Length; i++)
            {
                dogCharList[i] = dogCharList[i].Trim();
            }

            Array.Sort(dogCharList); //sorting alphanumerically
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string term in dogCharList)
                    {
